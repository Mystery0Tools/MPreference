...
class PageMPreferenceViewHolder(layoutInflater: LayoutInflater) : BaseMPreferenceViewHolder<PageMPreference>(layoutInflater.inflate(R.layout.layout_mpreference_text, null)) {
    override fun layout(context: Context, config: MPreferenceConfig, base: PageMPreference) {
    ...
    override fun onInterface(base: PageMPreference) {
